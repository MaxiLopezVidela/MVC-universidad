...
public class EstudianteJpaController {
    ...
    public void edit(Estudiante est) throws Exception {
        ...
        try {
            ...
            if (estBD == null)
                throw new NonexistentEntityException("No existe estudiante con id " + est.getAspiranteAGrado());
    ...
    public void destroy(int id) throws Exception {
        ...
        Estudiante est = em.find(Estudiante.class, id);
        if (est == null)
            throw new NonexistentEntityException("No existe estudiante con id " + id);
